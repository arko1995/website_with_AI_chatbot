      ...
      <section className="work-section shell" id="work">
        <div className="section-heading split-heading">
          <div>
            ...
            <h2>
              Projects become easier to trust when people can see the thinking.
            </h2>
          </div>
          <p>
            Large visual moments create the proof. The site stays restrained so
            the work does the persuasion.
          </p>
        </div>
        ...
        <div className="shell process-grid">
          <div className="process-intro">
            <div className="eyebrow light">
              <span>05</span>HOW IT MOVES
            </div>
            <h2>Less friction between an idea and a useful next step.</h2>
          </div>
          <div className="process-steps">
            {[
              [
                ...
                "A few details about project type, location and stage are enough to start.",
              ],
              [
                "02",
                "Get the right technical conversation",
                "The team can quickly identify whether you need feasibility, design, documentation, visualization or cost support.",
              ],
              [
                "03",
                "Move toward a buildable scope",
                "The next step is framed around decisions, deliverables and project reality — not generic sales talk.",
              ],
            ].map(([n, t, d]) => (
